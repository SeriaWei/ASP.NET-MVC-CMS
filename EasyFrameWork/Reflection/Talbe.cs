...
namespace SeriaWei.Data
{
    public static class Talbe
    {
        /// <summary>
        /// 获取表里某页的数据
        /// </summary>
        ...
        public static string GetValue_String(System.Data.DataTable table, int Row, string Collum)
        {
        ...
        /// <param name="Collum">列名称</param>
        /// <returns>返回字符串类型</returns>
        public static string GetValue_String(System.Data.DataTable table, int Row, int Collum)
        {
            return Convert.ToString(table.Rows[Row][Collum]);
        }
        ...
        public static long GetValue_Long(System.Data.DataTable table, int Row, string Collum)
        {
        ...
        /// <param name="Collum">列名称</param>
        /// <returns>返回长整形</returns>
        public static long GetValue_Long(System.Data.DataTable table, int Row, int Collum)
        {
            return Convert.ToInt64(table.Rows[Row][Collum]);
        }
        /// <summary>
        ...
        public static DateTime GetValue_DateTime(System.Data.DataTable table, int Row, string Collum)
        {
        ...
        /// <param name="Collum">列名称</param>
        /// <returns>返回日期</returns>
        public static DateTime GetValue_DateTime(System.Data.DataTable table, int Row, int Collum)
        {
            return Convert.ToDateTime(table.Rows[Row][Collum]);
        }
        /// <summary>
        ...
        public static int GetValue_Int(System.Data.DataTable table, int Row, string Collum)
        {
        ...
        /// <param name="Collum">列名称</param>
        /// <returns>返回整形</returns>
        public static int GetValue_Int(System.Data.DataTable table, int Row, int Collum)
        {
            return Convert.ToInt32(table.Rows[Row][Collum]);
        }
        /// <summary>
        ...
        public static double GetValue_Double(System.Data.DataTable table, int Row, string Collum)
        {
        ...
        /// <param name="Collum">列名称</param>
        /// <returns>返回双精度型</returns>
        public static double GetValue_Double(System.Data.DataTable table, int Row, int Collum)
        {
            return Convert.ToDouble(table.Rows[Row][Collum]);
        }
        /// <summary>
        ...
        public static decimal GetValue_Decimal(System.Data.DataTable table, int Row, string Collum)
        {
        ...
        /// <param name="Collum">列名称</param>
        /// <returns>返回货币类型</returns>
        public static decimal GetValue_Decimal(System.Data.DataTable table, int Row, int Collum)
        {
            return Convert.ToDecimal(table.Rows[Row][Collum]);
        }
        /// <summary>
        ...
        public static System.Data.DataTable GetLastNode(System.Data.DataTable table, int TopID, string IDColl, string PIDColl)
        {
