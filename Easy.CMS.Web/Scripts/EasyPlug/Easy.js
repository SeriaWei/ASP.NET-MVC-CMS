...
Easy.ShowMessageBox = function (title, msg, fnOk, ShowCancel, zindex) {
    ...
    box.fadeTo(0, 0);
    var okButton = $("<input id='MessageBoxOkBtn' type='button' class='btn btn-primary btn-sm' value='确定' />");
    ...
    if (typeof ShowCancel == "boolean") {
        if (ShowCancel) {
            var CancelButton = $("<input id='MessageBoxCancelBtn' type='button' class='btn btn-info btn-sm' value='取消' />");
