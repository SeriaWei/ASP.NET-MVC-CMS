...
tinymce.PluginManager.add('filebrowser', function (editor) {
    ...
    function initResult(obj) {
        var path = $(obj).data("result");
        var name = $(obj).data("name");
        var result = { ele: "", attr: {}, innerText: "" }
        path = path.toLowerCase();
        if (/.*[\.jpg|\.gif|\.png|\.jpeg|\.bmp|\.jpe]$/.test(path)) {
            result.ele = "img";
            ...
            result.ele = "a";
            result.attr = { href: path, "class": "btn btn-primary", download: name, title: name };
            result.innerText = "下载";
        }
        return result;
    }
