...
GO
INSERT [dbo].[CMS_Media] ([ID], [ParentID], [Title], [MediaType], [Url], [Status], [CreateBy], [CreatebyName], [CreateDate], [LastUpdateBy], [LastUpdateByName], [LastUpdateDate], [Description]) VALUES (N'6056810a7ede46bb94b55b2756323640', N'#', N'ͼƬ', 1, NULL, NULL, N'admin', N'ZKEASOFT', CAST(N'2016-04-01 21:42:14.960' AS DateTime), N'admin', N'ZKEASOFT', CAST(N'2016-04-01 21:42:14.960' AS DateTime), NULL)
GO
